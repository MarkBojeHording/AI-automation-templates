...
export default function LoadingSpinner({ message = "Generating your headshot..." }: LoadingSpinnerProps) {
  return (
    <div className="flex flex-col items-center justify-center p-8">
      ...
      <p className="mt-4 text-gray-600 text-center max-w-xs">{message}</p>
    </div>
  )
}
