...
<!-- Tagline -->
<div align="center">
  <h3>⚡ Prebuilt AI automation workflows for business, travel, and content – powered by n8n</h3>
</div>
...
|------|----------|------------|------------|-----------|---------------|
| **n8n** | Self-hosted, complex workflows  ~30 min | 9 workflows | [📖 n8n Docs](n8n/README.md) |
